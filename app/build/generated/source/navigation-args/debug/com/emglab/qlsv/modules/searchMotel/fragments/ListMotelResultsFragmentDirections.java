...
public class ListMotelResultsFragmentDirections {
  private ListMotelResultsFragmentDirections() {
  }

  @NonNull
  public static ActionListMotelResultsFragmentToMotelInfoFragment actionListMotelResultsFragmentToMotelInfoFragment(
      @NonNull Motel motel) {
    return new ActionListMotelResultsFragmentToMotelInfoFragment(motel);
  }

  public static class ActionListMotelResultsFragmentToMotelInfoFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionListMotelResultsFragmentToMotelInfoFragment(@NonNull Motel motel) {
      if (motel == null) {
    ...
    @NonNull
    public ActionListMotelResultsFragmentToMotelInfoFragment setMotel(@NonNull Motel motel) {
      if (motel == null) {
        throw new IllegalArgumentException("Argument \"motel\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("motel", motel);
    ...
    public int getActionId() {
      return R.id.action_listMotelResultsFragment_to_motelInfoFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionListMotelResultsFragmentToMotelInfoFragment that = (ActionListMotelResultsFragmentToMotelInfoFragment) object;
    ...
    public String toString() {
      return "ActionListMotelResultsFragmentToMotelInfoFragment(actionId=" + getActionId() + "){"
          + "motel=" + getMotel()
          + "}";
    }
  }
