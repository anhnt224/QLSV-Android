...
public class TListRegisterFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private TListRegisterFragmentArgs() {
  }

  private TListRegisterFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static TListRegisterFragmentArgs fromBundle(@NonNull Bundle bundle) {
    TListRegisterFragmentArgs __result = new TListRegisterFragmentArgs();
    bundle.setClassLoader(TListRegisterFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    TListRegisterFragmentArgs that = (TListRegisterFragmentArgs) object;
  ...
  public String toString() {
    return "TListRegisterFragmentArgs{"
        + "gift=" + getGift()
        + "}";
  }
  ...
  public static class Builder {
    ...
    public Builder(TListRegisterFragmentArgs original) {
    ...
    @NonNull
    public TListRegisterFragmentArgs build() {
      TListRegisterFragmentArgs result = new TListRegisterFragmentArgs(arguments);
      return result;
    }
