...
public class TScholarShipDetailFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private TScholarShipDetailFragmentArgs() {
  }

  private TScholarShipDetailFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static TScholarShipDetailFragmentArgs fromBundle(@NonNull Bundle bundle) {
    TScholarShipDetailFragmentArgs __result = new TScholarShipDetailFragmentArgs();
    bundle.setClassLoader(TScholarShipDetailFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    TScholarShipDetailFragmentArgs that = (TScholarShipDetailFragmentArgs) object;
  ...
  public String toString() {
    return "TScholarShipDetailFragmentArgs{"
  ...
  public static class Builder {
    ...
    public Builder(TScholarShipDetailFragmentArgs original) {
    ...
    @NonNull
    public TScholarShipDetailFragmentArgs build() {
      TScholarShipDetailFragmentArgs result = new TScholarShipDetailFragmentArgs(arguments);
      return result;
    }
