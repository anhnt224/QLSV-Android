...
public class TListScholarShipsFragmentDirections {
  private TListScholarShipsFragmentDirections() {
  }

  @NonNull
  public static ActionTListScholarShipsFragmentToTScholarShipDetailFragment actionTListScholarShipsFragmentToTScholarShipDetailFragment(
      @NonNull ScholarShip scholarShip) {
    return new ActionTListScholarShipsFragmentToTScholarShipDetailFragment(scholarShip);
  }

  public static class ActionTListScholarShipsFragmentToTScholarShipDetailFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionTListScholarShipsFragmentToTScholarShipDetailFragment(
        @NonNull ScholarShip scholarShip) {
      if (scholarShip == null) {
    ...
    @NonNull
    public ActionTListScholarShipsFragmentToTScholarShipDetailFragment setScholarShip(
        @NonNull ScholarShip scholarShip) {
      if (scholarShip == null) {
        throw new IllegalArgumentException("Argument \"scholarShip\" is marked as non-null but was passed a null value.");
      }
    ...
    public int getActionId() {
      return R.id.action_TListScholarShipsFragment_to_TScholarShipDetailFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionTListScholarShipsFragmentToTScholarShipDetailFragment that = (ActionTListScholarShipsFragmentToTScholarShipDetailFragment) object;
    ...
    public String toString() {
      return "ActionTListScholarShipsFragmentToTScholarShipDetailFragment(actionId=" + getActionId() + "){"
