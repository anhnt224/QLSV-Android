...
public class FormDetailFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private FormDetailFragmentArgs() {
  }

  private FormDetailFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static FormDetailFragmentArgs fromBundle(@NonNull Bundle bundle) {
    FormDetailFragmentArgs __result = new FormDetailFragmentArgs();
    bundle.setClassLoader(FormDetailFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    FormDetailFragmentArgs that = (FormDetailFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(FormDetailFragmentArgs original) {
    ...
    @NonNull
    public FormDetailFragmentArgs build() {
      FormDetailFragmentArgs result = new FormDetailFragmentArgs(arguments);
      return result;
    }
