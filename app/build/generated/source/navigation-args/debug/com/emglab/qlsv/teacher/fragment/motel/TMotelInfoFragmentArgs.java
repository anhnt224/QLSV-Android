...
public class TMotelInfoFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private TMotelInfoFragmentArgs() {
  }

  private TMotelInfoFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static TMotelInfoFragmentArgs fromBundle(@NonNull Bundle bundle) {
    TMotelInfoFragmentArgs __result = new TMotelInfoFragmentArgs();
    bundle.setClassLoader(TMotelInfoFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    TMotelInfoFragmentArgs that = (TMotelInfoFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(TMotelInfoFragmentArgs original) {
    ...
    @NonNull
    public TMotelInfoFragmentArgs build() {
      TMotelInfoFragmentArgs result = new TMotelInfoFragmentArgs(arguments);
      return result;
    }
