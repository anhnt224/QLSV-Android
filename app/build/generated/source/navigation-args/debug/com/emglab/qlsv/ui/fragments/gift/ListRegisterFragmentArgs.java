...
public class ListRegisterFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ListRegisterFragmentArgs() {
  }

  private ListRegisterFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ListRegisterFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ListRegisterFragmentArgs __result = new ListRegisterFragmentArgs();
    bundle.setClassLoader(ListRegisterFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    ListRegisterFragmentArgs that = (ListRegisterFragmentArgs) object;
  ...
  public String toString() {
    return "ListRegisterFragmentArgs{"
        + "gift=" + getGift()
        + "}";
  }
  ...
  public static class Builder {
    ...
    public Builder(ListRegisterFragmentArgs original) {
    ...
    @NonNull
    public ListRegisterFragmentArgs build() {
      ListRegisterFragmentArgs result = new ListRegisterFragmentArgs(arguments);
      return result;
    }
