...
public class TApplyGiftFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private TApplyGiftFragmentArgs() {
  }

  private TApplyGiftFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static TApplyGiftFragmentArgs fromBundle(@NonNull Bundle bundle) {
    TApplyGiftFragmentArgs __result = new TApplyGiftFragmentArgs();
    bundle.setClassLoader(TApplyGiftFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    TApplyGiftFragmentArgs that = (TApplyGiftFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(TApplyGiftFragmentArgs original) {
    ...
    @NonNull
    public TApplyGiftFragmentArgs build() {
      TApplyGiftFragmentArgs result = new TApplyGiftFragmentArgs(arguments);
      return result;
    }
