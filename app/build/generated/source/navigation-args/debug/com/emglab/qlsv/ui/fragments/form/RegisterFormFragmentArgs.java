...
public class RegisterFormFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private RegisterFormFragmentArgs() {
  }

  private RegisterFormFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static RegisterFormFragmentArgs fromBundle(@NonNull Bundle bundle) {
    RegisterFormFragmentArgs __result = new RegisterFormFragmentArgs();
    bundle.setClassLoader(RegisterFormFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    RegisterFormFragmentArgs that = (RegisterFormFragmentArgs) object;
  ...
  public String toString() {
    return "RegisterFormFragmentArgs{"
        + "form=" + getForm()
        + "}";
  }
  ...
  public static class Builder {
    ...
    public Builder(RegisterFormFragmentArgs original) {
    ...
    @NonNull
    public RegisterFormFragmentArgs build() {
      RegisterFormFragmentArgs result = new RegisterFormFragmentArgs(arguments);
      return result;
    }
