...
public class TFormDetailFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private TFormDetailFragmentArgs() {
  }

  private TFormDetailFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static TFormDetailFragmentArgs fromBundle(@NonNull Bundle bundle) {
    TFormDetailFragmentArgs __result = new TFormDetailFragmentArgs();
    bundle.setClassLoader(TFormDetailFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    TFormDetailFragmentArgs that = (TFormDetailFragmentArgs) object;
  ...
  public String toString() {
    return "TFormDetailFragmentArgs{"
        + "form=" + getForm()
        + "}";
  }
  ...
  public static class Builder {
    ...
    public Builder(TFormDetailFragmentArgs original) {
    ...
    @NonNull
    public TFormDetailFragmentArgs build() {
      TFormDetailFragmentArgs result = new TFormDetailFragmentArgs(arguments);
      return result;
    }
