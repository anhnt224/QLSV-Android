...
public class TFormRegisteredFragmentDirections {
  private TFormRegisteredFragmentDirections() {
  }

  @NonNull
  public static ActionTFormRegisteredFragmentToTEditFormFragment actionTFormRegisteredFragmentToTEditFormFragment(
      @NonNull Form form, @NonNull Question[] questions) {
    return new ActionTFormRegisteredFragmentToTEditFormFragment(form, questions);
  }

  public static class ActionTFormRegisteredFragmentToTEditFormFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionTFormRegisteredFragmentToTEditFormFragment(@NonNull Form form,
    ...
    @NonNull
    public ActionTFormRegisteredFragmentToTEditFormFragment setForm(@NonNull Form form) {
      if (form == null) {
        throw new IllegalArgumentException("Argument \"form\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("form", form);
    ...
    @NonNull
    public ActionTFormRegisteredFragmentToTEditFormFragment setQuestions(
        @NonNull Question[] questions) {
      if (questions == null) {
        throw new IllegalArgumentException("Argument \"questions\" is marked as non-null but was passed a null value.");
      }
    ...
    public int getActionId() {
      return R.id.action_TFormRegisteredFragment_to_TEditFormFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionTFormRegisteredFragmentToTEditFormFragment that = (ActionTFormRegisteredFragmentToTEditFormFragment) object;
    ...
    public String toString() {
      return "ActionTFormRegisteredFragmentToTEditFormFragment(actionId=" + getActionId() + "){"
          + "form=" + getForm()
