...
public class ApplyGiftFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ApplyGiftFragmentArgs() {
  }

  private ApplyGiftFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ApplyGiftFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ApplyGiftFragmentArgs __result = new ApplyGiftFragmentArgs();
    bundle.setClassLoader(ApplyGiftFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    ApplyGiftFragmentArgs that = (ApplyGiftFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(ApplyGiftFragmentArgs original) {
    ...
    @NonNull
    public ApplyGiftFragmentArgs build() {
      ApplyGiftFragmentArgs result = new ApplyGiftFragmentArgs(arguments);
      return result;
    }
