...
public class MotelRegistrationProcessingFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private MotelRegistrationProcessingFragmentArgs() {
  }

  private MotelRegistrationProcessingFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static MotelRegistrationProcessingFragmentArgs fromBundle(@NonNull Bundle bundle) {
    MotelRegistrationProcessingFragmentArgs __result = new MotelRegistrationProcessingFragmentArgs();
    bundle.setClassLoader(MotelRegistrationProcessingFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    MotelRegistrationProcessingFragmentArgs that = (MotelRegistrationProcessingFragmentArgs) object;
  ...
  public String toString() {
    return "MotelRegistrationProcessingFragmentArgs{"
  ...
  public static class Builder {
    ...
    public Builder(MotelRegistrationProcessingFragmentArgs original) {
    ...
    @NonNull
    public MotelRegistrationProcessingFragmentArgs build() {
      MotelRegistrationProcessingFragmentArgs result = new MotelRegistrationProcessingFragmentArgs(arguments);
      return result;
    }
