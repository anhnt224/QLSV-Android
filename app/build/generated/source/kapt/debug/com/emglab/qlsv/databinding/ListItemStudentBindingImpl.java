...
public class ListItemStudentBindingImpl extends ListItemStudentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btInfo, 11);
        sViewsWithIds.put(R.id.btActivity, 12);
        sViewsWithIds.put(R.id.btMark, 13);
    }
    // views
    @NonNull
    ...
    public ListItemStudentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }
    private ListItemStudentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
