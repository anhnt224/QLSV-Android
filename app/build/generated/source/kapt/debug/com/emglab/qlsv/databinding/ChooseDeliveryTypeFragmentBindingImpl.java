...
public class ChooseDeliveryTypeFragmentBindingImpl extends ChooseDeliveryTypeFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.studentNameTil, 2);
        sViewsWithIds.put(R.id.studentIdTil, 3);
        sViewsWithIds.put(R.id.deliveryTypeTil, 4);
        sViewsWithIds.put(R.id.addressTil, 5);
        sViewsWithIds.put(R.id.noteTextView, 6);
        sViewsWithIds.put(R.id.doneButton, 7);
    }
    // views
    @Nullable
    ...
    public ChooseDeliveryTypeFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ChooseDeliveryTypeFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
