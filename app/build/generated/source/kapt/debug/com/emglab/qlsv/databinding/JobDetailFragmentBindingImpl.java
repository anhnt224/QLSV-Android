...
public class JobDetailFragmentBindingImpl extends JobDetailFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.buttonApply, 19);
    }
    // views
    @NonNull
    ...
    public JobDetailFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 20, sIncludes, sViewsWithIds));
    }
    private JobDetailFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read !job.isExpired()
                jobIsExpired = !JobIsExpired1;
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            com.emglab.qlsv.binding.BindingAdapterKt.goneUnless(this.linearLayout5, jobIsExpired);
