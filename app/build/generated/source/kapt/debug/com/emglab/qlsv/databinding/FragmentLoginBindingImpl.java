...
public class FragmentLoginBindingImpl extends FragmentLoginBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.loginResource == variableId) {
            setLoginResource((com.emglab.qlsv.common.Resource) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLoginResource(@Nullable com.emglab.qlsv.common.Resource LoginResource) {
        this.mLoginResource = LoginResource;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
        notifyPropertyChanged(BR.loginResource);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.emglab.qlsv.common.Resource<?> loginResource = mLoginResource;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.mboundView0.setResource(loginResource);
        }
