...
public class ListItemGiftBindingImpl extends ListItemGiftBinding  {
    ...
    public ListItemGiftBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ListItemGiftBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String giftRegisteredQuantityStr = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                if (gift != null) {
                    ...
                    // read gift.registeredQuantityStr
                    giftRegisteredQuantityStr = gift.getRegisteredQuantityStr();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView6, giftRegisteredQuantityStr);
        }
    }
