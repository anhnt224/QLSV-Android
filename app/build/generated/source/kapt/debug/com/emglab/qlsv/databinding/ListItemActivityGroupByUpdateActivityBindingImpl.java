...
public class ListItemActivityGroupByUpdateActivityBindingImpl extends ListItemActivityGroupByUpdateActivityBinding  {
    ...
    public ListItemActivityGroupByUpdateActivityBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 1, sIncludes, sViewsWithIds));
    }
    private ListItemActivityGroupByUpdateActivityBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.widget.RadioButton) bindings[0]
            );
        this.rbtnActivity.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x9L) != 0) {
            ...
            this.rbtnActivity.setOnClickListener(clickListener);
        }
        if ((dirtyFlags & 0xaL) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.rbtnActivity, activityGroupAgDesc);
        }
        if ((dirtyFlags & 0xcL) != 0) {
            // api target 1

            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rbtnActivity, androidxDatabindingViewDataBindingSafeUnboxCheck);
        }
    }
