...
public abstract class Home2FragmentBinding extends ViewDataBinding {
  ...
  @NonNull
  public static Home2FragmentBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.home2_fragment, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static Home2FragmentBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<Home2FragmentBinding>inflateInternal(inflater, R.layout.home2_fragment, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.home2_fragment, null, false, component)
   */
  @NonNull
  @Deprecated
  public static Home2FragmentBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<Home2FragmentBinding>inflateInternal(inflater, R.layout.home2_fragment, null, false, component);
  }

  public static Home2FragmentBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static Home2FragmentBinding bind(@NonNull View view, @Nullable Object component) {
    return (Home2FragmentBinding)bind(component, view, R.layout.home2_fragment);
  }
}
