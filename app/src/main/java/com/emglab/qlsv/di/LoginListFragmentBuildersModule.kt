 ...
 */
@Module
abstract class LoginListFragmentBuildersModule {

    @ContributesAndroidInjector()
    abstract fun contributeLostPasswordFragment(): LostPasswordFragment

    @ContributesAndroidInjector()
    abstract fun contributeCheckOTPLostPasswordFragment(): CheckOTPLostPasswordFragment
